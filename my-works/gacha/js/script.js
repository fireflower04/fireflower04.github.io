...
//1-100までのランダム
let randomNum = Math.ceil(Math.random()*100);/* 取得する数字が0を含まない→切上げ→ceil */
...
document.querySelector('#outer').innerHTML = '<p><img src="img/'+character[0]+'" alt=""></p><p><img src="img/'+character[1]+'" alt=""></p><p><img src="img/'+character[2]+'" alt=""></p>';
